...
class GUI:
    def __init__(self, height):
        ...
        img = Gtk.Image()
        img.set_from_file('azote.images').joinpath('icon_refresh.svg'))
        ...
        if len(common.displays) > 1:
            ...
            img = Gtk.Image()
            img.set_from_file('azote.images').joinpath('icon_split.svg'))
        ...
        img = Gtk.Image()
        img.set_from_file('azote.images').joinpath('icon_all.svg'))
        ...
        img = Gtk.Image()
        img.set_from_file('azote.images').joinpath('icon_apply.svg'))
        ...
        img = Gtk.Image()
        img.set_from_file('azote.images').joinpath('icon_about.svg'))
        ...
        img = Gtk.Image()
        img.set_from_file('azote.images').joinpath('icon_menu.svg'))
        ...
        img = Gtk.Image()
        img.set_from_file('azote.images').joinpath('icon_picker.svg'))
        ...
        img = Gtk.Image()
        img.set_from_file('azote.images').joinpath('icon_config.svg'))

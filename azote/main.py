...
class ImageToolbar(Gtk.HBox):
    def __init__(self, thumbnail):
        ...
        img = Gtk.Image()
        img.set_from_file(str(files('azote.images').joinpath('icon_image_menu.svg')))
...
class DisplayBox(Gtk.Box):
    ...
    def __init__(self, name, width, height, path=None, thumb=None, xrandr_idx=None):
        ...
        if thumb and os.path.isfile(thumb):
            ...
            pixbuf = GdkPixbuf.Pixbuf.new_from_file(str(files('azote.images').joinpath('empty.png')))
        ...
        img = Gtk.Image()
        img.set_from_file(str(files('azote.images').joinpath('icon_flip.svg')))
    ...
    def on_color_chosen(self, user_data, button):
        ...
        self.img.set_from_file(str(files('azote.images').joinpath('empty.png')))
        common.apply_button.set_sensitive(True)
...
class SortingButton(Gtk.Button):
    ...
    def refresh(self):
        if common.settings.sorting == 'old':
            self.img.set_from_file(str(files('azote.images').joinpath('icon_old.svg')))
        elif common.settings.sorting == 'az':
            self.img.set_from_file(str(files('azote.images').joinpath('icon_az.svg')))
        elif common.settings.sorting == 'za':
            self.img.set_from_file(str(files('azote.images').joinpath('icon_za.svg')))
        else:
            self.img.set_from_file(str(files('azote.images').joinpath('icon_new.svg')))
...
def on_about_button(button):
    ...
    logo = GdkPixbuf.Pixbuf.new_from_file_at_size(str(files('azote.images').joinpath('icon_new.svg'), 96, 96))
...
class GUI:
    def __init__(self, height):
        ...
        img = Gtk.Image()
        img.set_from_file(str(files('azote.images').joinpath('icon_refresh.svg')))
        ...
        if len(common.displays) > 1:
            ...
            img = Gtk.Image()
            img.set_from_file(str(files('azote.images').joinpath('icon_split.svg')))
        ...
        img = Gtk.Image()
        img.set_from_file(str(files('azote.images').joinpath('icon_all.svg')))
        ...
        img = Gtk.Image()
        img.set_from_file(str(files('azote.images').joinpath('icon_apply.svg')))
        ...
        img = Gtk.Image()
        img.set_from_file(str(files('azote.images').joinpath('icon_about.svg')))
        ...
        img = Gtk.Image()
        img.set_from_file(str(files('azote.images').joinpath('icon_menu.svg')))
        ...
        img = Gtk.Image()
        img.set_from_file(str(files('azote.images').joinpath('icon_picker.svg')))
        ...
        img = Gtk.Image()
        img.set_from_file(str(files('azote.images').joinpath('icon_config.svg')))
